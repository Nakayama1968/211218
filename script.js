/**
   ...
   */
   window.onload = function () {
    ...
    if (textvalue) {
      ...
      document.getElementById('tiltle-textarea').value = "大谷も使うマンダラチャート（タイトル変更可）";
    }
    ...
    document.getElementById('inputText5-1').value = localStorage.getItem('inputText5-1');
    ...
    document.getElementById('inputText5-1').value = localStorage.getItem('inputText5-1');
    document.getElementById('inputText5-2').value = localStorage.getItem('inputText5-2');
    document.getElementById('inputText5-3').value = localStorage.getItem('inputText5-3');
    document.getElementById('inputText5-4').value = localStorage.getItem('inputText5-4');
    document.getElementById('inputText5-5').value = localStorage.getItem('inputText5-5');
    document.getElementById('inputText5-6').value = localStorage.getItem('inputText5-6');
    document.getElementById('inputText5-7').value = localStorage.getItem('inputText5-7');
    document.getElementById('inputText5-8').value = localStorage.getItem('inputText5-8');
    document.getElementById('inputText5-9').value = localStorage.getItem('inputText5-9');
  ...
  */
  window.onbeforeunload = function () {
    ...
    textareavalue = document.getElementById('inputText5-1').value;
    localStorage.setItem('cinputText5-1', textareavalue);
    ...
    textareavalue = document.getElementById('inputText5-1').value;
    localStorage.setItem('inputText5-1', textareavalue);
    textareavalue = document.getElementById('inputText5-2').value;
    localStorage.setItem('inputText5-2', textareavalue);
    textareavalue = document.getElementById('inputText5-3').value;
    localStorage.setItem('inputText5-3', textareavalue);
    textareavalue = document.getElementById('inputText5-4').value;
    localStorage.setItem('inputText5-4', textareavalue);
    textareavalue = document.getElementById('inputText5-5').value;
    localStorage.setItem('inputText5-5', textareavalue);
    textareavalue = document.getElementById('inputText5-6').value;
    localStorage.setItem('inputText5-6', textareavalue);
    textareavalue = document.getElementById('inputText5-7').value;
    localStorage.setItem('inputText5-7', textareavalue);
    textareavalue = document.getElementById('inputText5-8').value;
    localStorage.setItem('inputText5-8', textareavalue);
    textareavalue = document.getElementById('inputText5-9').value;
    localStorage.setItem('inputText5-9', textareavalue);
  ...
  */
  function deletelocalstrage() {
    ...
    localStorage.removeItem('inputText5-1Pv');
    document.getElementById('inputText5-1Pv').value = '';
    ...
    localStorage.removeItem('inputText5-2Pv');
    document.getElementById('inputText5-2Pv').value = '';
    ...
    localStorage.removeItem('inputText5-3Pv');
    document.getElementById('inputText5-3Pv').value = '';
    ...
    localStorage.removeItem('inputText5-4Pv');
    document.getElementById('inputText5-4Pv').value = '';
    ...
    localStorage.removeItem('inputText5-1');
    document.getElementById('inputText5-1').value = '';
    localStorage.removeItem('inputText5-2');
    document.getElementById('inputText5-2').value = '';
    localStorage.removeItem('inputText5-3');
    document.getElementById('inputText5-3').value = '';
    localStorage.removeItem('inputText5-4');
    document.getElementById('inputText5-4').value = '';
    localStorage.removeItem('inputText5-5');
    document.getElementById('inputText5-5').value = '';
    localStorage.removeItem('inputText5-6');
    document.getElementById('inputText5-6').value = '';
    localStorage.removeItem('inputText5-7');
    document.getElementById('inputText5-7').value = '';
    localStorage.removeItem('inputText5-8');
    document.getElementById('inputText5-8').value = '';
    localStorage.removeItem('inputText5-9');
    document.getElementById('inputText5-9').value = '';
    ...
    localStorage.removeItem('inputText5-6Pv');
    document.getElementById('inputText5-6Pv').value = '';
    ...
    localStorage.removeItem('inputText5-7Pv');
    document.getElementById('inputText5-7Pv').value = '';
    ...
    localStorage.removeItem('inputText5-8Pv');
    document.getElementById('inputText5-8Pv').value = '';
    ...
    localStorage.removeItem('inputText5-9Pv');
    document.getElementById('inputText5-9Pv').value = '';
